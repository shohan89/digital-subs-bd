...
/** Single-image control for the product form's "Main image" field — uploads immediately on
 * selection (via `uploadProductImageAction`) and stores the resulting public URL as the field
 * value, rather than holding a raw `File` in form state until submit. */
